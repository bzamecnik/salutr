...
#mongoimport -d soykaSpringTest -c name_vocatives --headerline --type csv --file single_names_full.csv

zcat single_names_full.csv.gz |mongoimport -d soykacz -c name_vocatives --headerline --type csv